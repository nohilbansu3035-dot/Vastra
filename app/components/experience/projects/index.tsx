...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      ...
      if (camera.position.y > -10) {
        // Just loaded from the Back to Home push directly into the active portal.
        // Snap immediately so GSAP and TouchPanControls don't fight over the 0 rotation.
        camera.position.set(isMobile ? 1 : 2, -39, 11.5);
  ...
  }, [isActive, camera, data.el, isMobile]);
